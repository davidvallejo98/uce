...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  if (isset($_POST['crear'])) {
    ...
    header("Location: usuarios_docente.php");
    exit();
  }
}
...
$result = $conn->query("SELECT u.ci, u.nombres, u.apellidos, u.correo_institucional, p.tipo_usuario FROM usuarios u INNER JOIN permisos p on u.id_permisos=p.id_permisos WHERE u.id_permisos=3");
...
<body>
  ...
  <div class="container mt-4">
    <header class="text-center mb-4">
      ...
      <p class="lead">Lista de estudiantes registrados en el sistema.</p>
      <div id="reloj"></div>
    </header>
    <!-- Botón Crear Usuario -->
